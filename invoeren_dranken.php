    ...
    <div class="container">
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-6">
                    <h3>Invoeren bestelling dranken tafel <?php echo $tafelNummerGet ?></h3>
                </div>
                <div class="col-sm">
                </div>
            </div>
